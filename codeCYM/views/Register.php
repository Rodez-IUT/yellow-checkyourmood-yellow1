...
<head>
    ...
    <link rel="stylesheet" href="/yellow-checkyourmood-yellow1/codeCYM/CSS/Register.css">
    ...
    <script src="/yellow-checkyourmood-yellow1/codeCYM/third-party/JQuery/jquery-3.6.1.js"></script>
    <script src="/yellow-checkyourmood-yellow1/codeCYM/JS/register.js" defer></script>
    ...
    <div class="container">
        <div class="Main">
            <div class="Register-block">
                ...
                <form action="#" method="get" class="main-mid" id="form">
                    ...
                    <select class="select-size input-text shifter display-none" name="gender" id="gender" aria-label='Sélection du genre'>
                    ...
                    <div class="checkbox">
                        <input id="check" type="checkbox" name="check" aria-label="Afficher le mot de passe"> Afficher le mot de passe
                    </div>
                    <input type="text" id="login" name="login" value="1" hidden>
                    <input type="submit" class="input-button" name="send"  value="Valider" aria-label="Valider">
                </form>
            </div>
        </div>
        <div class="bot">
