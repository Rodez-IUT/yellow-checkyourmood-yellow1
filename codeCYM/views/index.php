...
<html lang="fr">
    <head>
        ...
        <link rel="stylesheet" href="/yellow-checkyourmood-yellow1/codeCYM/CSS/menu.css">
        <link rel="stylesheet" href="/yellow-checkyourmood-yellow1/codeCYM/third-party/bootstrap/css/bootstrap.css">
        <link rel="apple-touch-icon" sizes="180x180" href="/yellow-checkyourmood-yellow1/codeCYM/assets/favicon/apple-touch-icon.png">
        <link rel="icon" type="image/png" sizes="32x32" href="/yellow-checkyourmood-yellow1/codeCYM/codeCYM/codeCYM/assets/favicon/favicon-32x32.png">
        <link rel="icon" type="image/png" sizes="16x16" href="/yellow-checkyourmood-yellow1/codeCYM/codeCYM/codeCYM/assets/favicon/favicon-16x16.png">
        <link rel="manifest" href="/site.webmanifest">
        <link rel="mask-icon" href="/yellow-checkyourmood-yellow1/codeCYM/codeCYM/assets/favicon/safari-pinned-tab.svg" color="#5bbad5">
        <meta name="msapplication-TileColor" content="#da532c">
        <meta name="theme-color" content="#ffffff">
        <script src="/yellow-checkyourmood-yellow1/codeCYM/codeCYM/JS/header-component.js" defer></script>     
        <title>Accueil</title>
    </head>
    <body>
        <?php
